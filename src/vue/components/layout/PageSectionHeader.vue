<template>
    <div class="png-section-header">
        <h1 class="png-section-header-title" v-html="parsedTitle"/>
        <h5 class="png-section-header-subtitle pt-1" v-html="parsedSubtitle"/>
    </div>
</template>
