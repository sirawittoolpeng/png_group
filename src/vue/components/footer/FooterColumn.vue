<template>
    <div class="png-footer-col col-12 col-lg-4">
        <!-- Column Title -->
        <h5 class="png-footer-col-title">
            <i v-if="props.faIcon"
               :class="props.faIcon"/>
        ...
        <div v-if="props.description.length > 0"
             class="png-footer-col-item">
            <div class="png-footer-col-description">
        ...
        <div v-if="props.links.length > 0 && props.displayLinksAsButtons"
             class="png-footer-col-item mt-3">
        ...
        <!-- Inline Links -->
        <div v-if="props.links.length > 0 && !props.displayLinksAsButtons"
             class="png-footer-col-item mt-2 mt-lg-1">
...
div.png-footer-col-description {
    display: flex;
