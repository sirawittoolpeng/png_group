<template>
    ...
    <div v-if="visible && currentStep"
         ...
         class="png-loader"
         :class="{
            'png-loader-tween-in': currentStep === Steps.WILL_ENTER,
            'png-loader-tween-out': currentStep === Steps.LEAVING
         }">
        <!-- Loader Content -->
        <div class="png-loader-content">
            ...
            <div class="png-loader-progress-display"
                 :class="{
                    'png-loader-progress-display-hidden': currentStep <  Steps.ANIMATING_PROGRESS,
                    'transition-none': currentStep < Steps.ANIMATING_PROGRESS
                 }">
                <p class="percentage text-2"
                   v-html="`${percentage}%`"/>

                <ProgressBar class="png-loader-progress-bar"
...
const _updateProgress = (dt) => {
    const isPageLoaded = Boolean(document.querySelector('.png-page-wrapper'))
...
div.png-loader-progress-display {
    margin-top: 5px;
    overflow: hidden;
    z-index: 5;
