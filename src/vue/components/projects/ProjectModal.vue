<template>
    <div class="modal modal-xl fade png-project-modal"
         id="png-project-modal"
         tabindex="-1"
         aria-labelledby="png-project-modal-label">
...
onMounted(() => {
    const elModal = document.getElementById("png-project-modal")
